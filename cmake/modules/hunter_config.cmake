...
macro(hunter_config)
  ...
  message(STATUS "_hunter_localdir_consume is "${_hunter_localdir_consume})
  if(_hunter_localdir_consume)
    message(STATUS "_hunter_localdir_consume is true ")
  else()
    message(STATUS "_hunter_localdir_consume is false ")
  endif()
